...
superheroes_15 = superheroes[:15]


def buscar_capitan(lista, posicion=0):
    if posicion == len(lista):
        return False

    if lista[posicion]["name"] == "Captain America":
        return True

    return buscar_capitan(lista, posicion + 1)


def listar_superheroes_recursivo(lista, posicion=0):
    if posicion == len(lista):
        return

    print(lista[posicion]["name"])

    listar_superheroes_recursivo(lista, posicion + 1)


print("\n1. Buscar si Captain America esta en la lista")

if buscar_capitan(superheroes_15):
    print("Captain America esta en la lista")
else:
    print("Captain America NO esta en la lista")


print("\n2. Listar los superheroes de la lista")

listar_superheroes_recursivo(superheroes_15)
...
def ordenar_pila(pila, campo):
    ...
    while not pila.pila_vacia():
        ...
        while not aux.pila_vacia():
            ...
            valor_cima = cima[campo]
            valor_elemento = elemento[campo]

            if valor_cima is None:
                valor_cima = ""

            if valor_elemento is None:
                valor_elemento = ""

            if valor_cima > valor_elemento:
                pila.apilar(aux.desapilar())
            else:
                break
    ...
    while not aux.pila_vacia():
        resultado.apilar(aux.desapilar())
...
pila = cargar_pila(superheroes)


print("\nEJERCICIO 2")


print("\n3. Listado ordenado de manera ascendente por nombre de los personajes")

p1 = ordenar_pila(copiar_pila(pila), "name")

while not p1.pila_vacia():
    personaje = p1.desapilar()
    print(personaje["name"])


print("\n4. Determinar en que posicion esta The Thing y Rocket Raccoon")

aux = copiar_pila(pila)
...
while not aux.pila_vacia():
    ...
    personaje = aux.desapilar()
    posicion += 1

    if personaje["name"] == "The Thing":
        posicion_thing = posicion

    if personaje["name"] == "Rocket Raccoon":
        posicion_rocket = posicion

print("The Thing:", posicion_thing)
print("Rocket Raccoon:", posicion_rocket)


print("\n5. Listar todos los villanos de la lista")
...
print("\n6. Poner todos los villanos en una cola para determinar cuales aparecieron antes de 1980")
...
while not aux.pila_vacia():
    ...
    if personaje["is_villain"] == True:
        cola_villanos.arribo(personaje)


while not cola_villanos.cola_vacia():

    personaje = cola_villanos.atencion()

    if personaje["first_appearance"] < 1980:
        mostrar_personaje(personaje)


print("\n7. Listar los superheroes que comienzan con Bl, G, My y W")
...
while not aux.pila_vacia():
    ...
    if personaje["is_villain"] == False:

        nombre = personaje["name"]

        if nombre[0] == "B" and nombre[1] == "l":
            print(nombre)

        elif nombre[0] == "G":
            print(nombre)

        elif nombre[0] == "M" and nombre[1] == "y":
            print(nombre)
...
print("\n8. Listado de personajes ordenado por nombre real de manera ascendente")

p6 = ordenar_pila(copiar_pila(pila), "real_name")

while not p6.pila_vacia():

    personaje = p6.desapilar()

    print(personaje["real_name"], "-", personaje["name"])


print("\n9. Listado de superheroes ordenados por fecha de aparicion")
...
while not p7.pila_vacia():

    personaje = p7.desapilar()

    while not p7_ordenada.pila_vacia():

        cima = p7_ordenada.ver_cima()

        if cima["first_appearance"] > personaje["first_appearance"]:
            p7.apilar(p7_ordenada.desapilar())
        else:
            break

    p7_ordenada.apilar(personaje)


while not p7_ordenada.pila_vacia():

    personaje = p7_ordenada.desapilar()
...
print("\n10. Modificar el nombre real de Ant Man a Scott Lang")
...
print("\n11. Mostrar los personajes que en su biografia incluyan time-traveling o suit")
...
while not aux.pila_vacia():
    ...
    biografia = personaje["short_bio"]

    if "time-traveling" in biografia:
        print(personaje["name"])

    elif "suit" in biografia:
        print(personaje["name"])


print("\n12. Eliminar a Electro y Baron Zemo de la lista y mostrar su informacion")
...
while not pila.pila_vacia():
    ...
    if personaje["name"] == "Electro":
        print("Electro encontrado:")
        mostrar_personaje(personaje)

    elif personaje["name"] == "Baron Zemo":
        print("Baron Zemo encontrado:")
        mostrar_personaje(personaje)
